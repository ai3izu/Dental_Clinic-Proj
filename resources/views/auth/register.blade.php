...
<body class="bg-gradient-to-b from-[#3E92CC] to-[#62B6CB] h-screen flex items-center justify-center flex-col">
    ...
    <div class="bg-white p-6 sm:p-4 md:p-10 rounded-lg shadow-lg w-full max-w-sm sm:max-w-md"
        **aria-labelledby="register-heading" **>
        <h2 id="register-heading" class="text-2xl sm:text-3xl font-semibold text-[#13293D] mb-4 sm:mb-6">Zarejestruj się
        </h2>

        @if ($errors->any())
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-2 sm:mb-4" **role="alert"
                aria-live="assertive" **>
                <strong>Błąd:</strong>
        ...
        <form method="POST" action="{{ route('register.post') }}" **aria-label="Formularz rejestracji" **>
            @csrf
            <div class="mb-2 sm:mb-4">
                ...
                <input type="text" name="first_name" id="first_name"
                    ...
                    required **aria-label="Wprowadź swoje imię" **>
            </div>
            ...
            <div class="mb-2 sm:mb-4">
                ...
                <input type="text" name="last_name" id="last_name"
                    class="w-full p-2 sm:p-3 border border-[#2A628F] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5FA8D3] text-sm sm:text-base"
                    required **aria-label="Wprowadź swoje nazwisko" **>
            </div>
            ...
            <div class="mb-2 sm:mb-4">
                ...
                <input type="password" name="password" id="password"
                    class="w-full p-2 sm:p-3 border border-[#2A628F] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5FA8D3] text-sm sm:text-base"
                    required **aria-label="Wprowadź hasło" **>
            </div>
            ...
            <div class="mb-4 sm:mb-6">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation"
                    class="w-full p-2 sm:p-3 border border-[#2A628F] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5FA8D3] text-sm sm:text-base"
                    required **aria-label="Potwierdź swoje hasło" **>
            </div>
            ...
            <button type="submit"
                ...
                **aria-label="Zarejestruj się" **>Zarejestruj
                się</button>
        </form>

        <p class="mt-2 sm:mt-4 text-center text-sm sm:text-base">
            Masz już konto? <a href="{{ route('login') }}" class="text-[#5FA8D3] hover:underline"
                **aria-label="Przejdź do strony logowania" **>Zaloguj się</a>
        </p>
        <p class="mt-2 sm:mt-4 text-center text-sm sm:text-base">
