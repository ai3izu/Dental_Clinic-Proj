...
@section('content')
    <div
        ...
        <h2 class="text-xl sm:text-2xl font-bold text-[#13293D] mb-5 sm:mb-6">Edytuj dentystę</h2>

        <form action="{{ route('admin.doctors.update', $doctor->id) }}" method="POST" class="space-y-3 sm:space-y-4">
            @csrf
            @method('PUT')
