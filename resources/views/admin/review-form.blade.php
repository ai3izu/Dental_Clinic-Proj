    ...
    <form method="POST"
        ...
        <div>
            ...
            <select name="doctor_id" id="doctor_id" required
                ...
                aria-describedby="doctor_id-error" @error('doctor_id') aria-invalid="true" @enderror {{ isset($review) ? 'disabled' : '' }} **aria-label="Wybierz lekarza" **>
        ...
        <div>
            ...
            <select name="patient_id" id="patient_id" required
                ...
                aria-describedby="patient_id-error" @error('patient_id') aria-invalid="true" @enderror {{ isset($review) ? 'disabled' : '' }} **aria-label="Wybierz pacjenta" **>
        ...
        <div>
            ...
            <textarea name="content" id="content" placeholder="Wpisz treść opinii"
                class="border p-2 rounded w-full mt-1 @error('content') border-red-500 @enderror"
                aria-describedby="content-error" @error('content') aria-invalid="true" @enderror rows="5"
                **aria-label="Treść opinii" **>{{ old('content', $review->content ?? '') }}</textarea>
            @error('content')
